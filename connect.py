...
class App(object):
    ...
    def __init__(self, app_client_id, app_client_secret, **kwargs):
        print("App __init__")
        self.c = Connect(app_client_id, app_client_secret, debug_mode= True, **kwargs)
        self.streams = []
    ...
    def handle_command(self, command):
        ...
        if command == 'open':
            if self.c.session_id == '':
                ...
                self.c.unbind(self.c.bind_async(self.loop, create_session_done = self.receive_message))
            else:
